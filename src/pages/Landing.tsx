    ...
    <div className="relative w-full bg-foreground">
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
          ...
          >
            Curated collections from the world's most exciting contemporary brands, with expert styling consultations
            in-store and online.
          </motion.p>
      ...
      <section className="relative z-10 bg-background">
        <div className="wyw-container py-24 text-center">
          <p className="font-body text-[0.625rem] tracking-[0.25em] uppercase text-muted-foreground mb-4">
            Curated Excellence
          </p>
          <h2 className="font-display text-[2.5rem] md:text-[3.5rem] italic text-foreground mb-6">
            Four Brands. One Vision.
          </h2>
          <p className="text-muted-foreground font-body font-light max-w-[55ch] mx-auto leading-[1.85] mb-12">
            Each W.Y.W partner brand brings a distinct aesthetic to our curation. From effortless femininity to urban
            precision, organic warmth to deliberate weight.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-border">
            {[
              ...
              >
                <h3 className="font-display text-[1.5rem] italic group-hover:text-primary transition-colors duration-500 text-foreground">
                  {brand.name}
                </h3>
