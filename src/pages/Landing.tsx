    ...
    <div className="relative min-h-screen w-full bg-foreground">
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <button
          ...
          className="absolute bottom-10 right-10 z-20 w-9 h-9 flex items-center justify-center text-white/30 hover:text-white/60 transition-colors"
        >
