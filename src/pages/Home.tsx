...
const occasions = [
  {
    title: "Office Ready",
    filter: "workwear",
    image: "https://images.unsplash.com/photo-1487222477894-8943e31ef7b2?w=600&q=80&fit=crop&crop=center",
  },
  {
    title: "Weekend Edit",
    filter: "casual",
    image: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=600&q=80&fit=crop&crop=center",
  },
  {
    title: "Evening Out",
    filter: "evening",
    image: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=600&q=80&fit=crop&crop=center",
  },
  {
    title: "Layering Season",
    filter: "outerwear",
    image: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=600&q=80&fit=crop&crop=center",
  },
];
        ...
        {campaigns.map((camp) => (
          ...
          >
            ...
            <div className="absolute bottom-10 left-10 z-10 text-white">
              ...
              <h2
                className="font-display text-[2rem] md:text-[2.5rem] leading-[1.05] italic mb-5"
                style={{ maxWidth: "16ch" }}
              >
                {camp.title}
              </h2>
      ...
      <section id="new-in" className="wyw-section">
        <div className="wyw-container">
          <div className="flex items-end justify-between mb-14">
            ...
            <Link
              to="/shop?filter=new"
              className="font-body text-[0.7rem] uppercase tracking-[0.15em] text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2"
            >
        ...
        <div className="wyw-container grid md:grid-cols-5 gap-16 items-center">
          <div className="md:col-span-3">
            ...
            <p className="text-muted-foreground font-body font-light leading-[1.8] mb-8 max-w-[55ch]">
              Our expert stylists will help you build the perfect wardrobe. In-store or virtual — your choice. Includes
              a six-month styling warranty.
            </p>
            <Link
              to="/consultation"
          ...
          <div className="md:col-span-2">
            <div className="aspect-[3/4] bg-muted flex items-center justify-center border border-border">
              <div className="text-center p-8">
                ...
                <p className="font-body text-[0.7rem] text-muted-foreground mt-4 tracking-wide">
      ...
      <section className="border-t border-border">
        <div className="wyw-container py-20">
          <div className="max-w-[50ch] mx-auto text-center">
            <p className="font-body text-[0.625rem] tracking-[0.2em] uppercase text-muted-foreground mb-6">
              A Note From Our Stylists
            </p>
            <p className="font-body font-light text-muted-foreground leading-[1.85] mb-6">
              Every piece we curate is chosen with intention. We believe in the quiet power of dressing well — not for
              attention, but for self-assurance. Visit us in-store, and you'll understand.
            </p>
