    ...
    <Layout>
      <div className="wyw-container pt-24 pb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {[
            { icon: MessageCircle, title: 'Live Chat', desc: 'Mon-Fri: 9am-8pm, Sat: 10am-6pm', cta: 'Start Chat' },
            { icon: Mail, title: 'Email', desc: 'help@wyw.com · Reply within 24hrs', cta: 'Send Email' },
            { icon: Phone, title: 'WhatsApp', desc: 'Quick questions? Message us.', cta: 'Open WhatsApp' },
          ].map((method, i) => (
            <Reveal key={method.title} delay={i * 80}>
              <div className="border border-border p-6 text-center">
                ...
                <Button variant={method.title === 'Live Chat' ? 'default' : 'outline'} size="sm">{method.cta}</Button>
              </div>
            </Reveal>
          ))}
        </div>
